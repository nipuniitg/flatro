...
<div class="container">
  ...
  <div class="col-md-12">
      <div class="breadcrumb"> <a href="index.php"> <i class="fa fa-home fa-fw"></i> Home </a> <i class="fa fa-angle-right fa-fw"></i> <a href="productlist.php"> <?php $categoryType = $_POST['categoryType']; echo $categoryType ;?>
	 </a> </div>
  ...
  <div class="row clearfix f-space10"></div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 main-column box-block">
...
<!-- Product -->
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 box-block sidebar">
      <div class="box-heading"><span>Specials</span></div>
      <div class="box-content">
          <div class="box-products slide" id="productc11">
              <div class="carousel-controls"> <a class="carousel-control left" data-slide="prev" href="#productc11"> <i class="fa fa-angle-left fa-fw"></i> </a> <a class="carousel-control right" data-slide="next" href="#productc11"> <i class="fa fa-angle-right fa-fw"></i> </a> </div>
              <div class="carousel-inner">
                  <!-- Items Row -->
                  <div class="item active">
                      <div class="row box-product">
...
<!-- item
            <div class="item">
              <div class="product-block">
                <div class="image"> <a class="img" href="product.html"><img alt="product info" src="images/products/prod.jpeg" title="product title"></a> </div>
                <div class="product-meta">
...
<?php
	...
	$query_str = "SELECT subcategory,sub_id as subid FROM level1 where category=$myvar";
	...
	if(!$result){
		...
		{
            echo "<div class=\"row clearfix f-space10\"></div>";
            ...
            echo "<div class=\"box-products slide\" id=\"productc{$productc}\">";
            echo "<div class=\"carousel-controls\"> <a class=\"carousel-control left\" data-slide=\"prev\" href=\"#productc{$productc}\"> <i class=\"fa fa-angle-left fa-fw\"></i> </a> <a class=\"carousel-control right\" data-slide=\"next\" href=\"#productc{$productc}\"> <i class=\"fa fa-angle-right fa-fw\"></i> </a> </div>";
            ...
            //product
            for($i=0; $i<2; $i++)
            {  // to fetch two products under one subcategory
